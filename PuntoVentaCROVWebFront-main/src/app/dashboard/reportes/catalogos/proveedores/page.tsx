...
export default function ReporteProveedoresPage() {
  ...
  const cargarProveedores = async () => {
    try {
      ...
      const data = (res.data || []) as Proveedor[]
  ...
  const exportarExcel = () => {
    ...
    XLSX.writeFile(workbook, 'reporte_proveedores.xlsx')
  }
  ...
  const exportarPDF = () => {
    ...
    autoTable(doc, {
      ...
      body: proveedoresFiltrados.map(p => [p.razon_social, p.telefono, p.email || ''])
    })
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-orange-600">Reporte de Proveedores</h1>
